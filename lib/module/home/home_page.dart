      ...
      children: <Widget>[
        DrawerHeader(
          child: Container(
            ...
            child: Column(
              children: <Widget>[
                CircleAvatar(backgroundImage: NetworkImage("https://static.thenounproject.com/png/17241-200.png"),),
                Text("Lê Thạch Lâm")
              ],
            ),
          ),
        ...
        ListTile(
          ...
          onTap: () => print("On tap lich su"),
        ),
        ListTile(
          title: Text("Thông tin khuyến mãi"),
          leading: Icon(Icons.insert_drive_file),
          onTap: () => print("On tap thong tin "),
        ),
        ListTile(
